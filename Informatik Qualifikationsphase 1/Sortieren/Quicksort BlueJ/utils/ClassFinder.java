// source: https://stackoverflow.com/a/22462785
package utils;
...
public class ClassFinder {
        ...
        if (directory.exists() && directory.isDirectory()) {
            ...
            for (final String file : files) {
                if (file.endsWith(".class")) {
                    try {
                        classes.add(Class
                                .forName(pckgname + '.' + file.substring(0, file.length() - 6)));
     ...
     * @param classes    the current ArrayList of all classes. This method will simply add new
     *                   classes.
