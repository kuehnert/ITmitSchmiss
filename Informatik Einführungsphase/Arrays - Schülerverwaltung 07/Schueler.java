public class Schueler implements Comparable {
    ...
    public Schueler(String line) {
        ...
        setNachname(werte[0]);// werte[0] => "Beutlin"
        setVorname(werte[1]);// werte[1] => "Frodo"
        setAlter( Integer.parseInt(werte[2]) );// werte[2] => "25"
        setDurchschnitt( Double.parseDouble(werte[3]) );// werte[3] => "3.1"
    }
